...
public class HospitalLoginFilter implements Filter {
	// 로그인 없이 접근할 수 있는 경로를 지정
	private ArrayList<String> whiteList = new ArrayList<>();
    public HospitalLoginFilter() {
    	...
    	whiteList.add("/ppp/hotel/hotelregister");
    	whiteList.add("/ppp/hospital/hospitalregister");
    	...
    	whiteList.add("/ppp/hotel/hotelscoresearch");
    }
	public void destroy() {
	}
