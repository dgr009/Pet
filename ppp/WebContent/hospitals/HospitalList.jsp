...
$(document).ready(function() {
	var areaHospitalList = <%= request.getAttribute("result") %>
	// 이름, 메일, 연락처, 위치 //사진
	$.each(areaHospitalList, function(index, h) {
		...
		var tagA = $("<a href='/ppp/hospital/hospitalview?hospital_no="+h.hospitalNo+"'></a>");
...
<%@ include file='../members/BigHeader.jsp' %>
	...
	<h2 class="list_title">Hospital List</h2>
	<form id="inline_form" action="/ppp/hospital/hospitalareasearch" method="get">
