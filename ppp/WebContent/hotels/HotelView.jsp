...
$(document).ready(function() {
	...
	var reserve_btn = div_btn1.append('<a href="/ppp/member/reservehotel?hotel_no=<%=h.getHotelNo()%>"><span id="fon">예약</span><img src="/ppp/images/reserv.png" alt="Alternate Text" width="150" height="70" /></a>');
