	...
	$(function() {
		$('#go').on('click',function(){
			$.ajax({
				...
				data: {hotel_id:$("#hotel_id").val(),hotel_mail:$("#hotel_mail").val(),hotel_orner_no:$("#hotel_orner_no").val()},
...
<body>
	...
	<p>아이디 : <input type='text' id='hotel_id' name='hotel_id'></p>
	<p>메일 : <input type='text' id='hotel_mail' name='hotel_mail'></p>
	<p>사업자 등록번호 : <input type='text' id='hotel_orner_no' name='hotel_orner_no'></p>
