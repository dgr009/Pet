	...
	<div>
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
				 <li><a href="/ppp/hotel/hotelareasearch">등록</a></li>
				<li><a href="#section2">게시판</a></li>
				<li><a href="#section3">고객센터</a></li>
				<li><a href="/ppp/hotel/hotelinfo" data-toggle="modal"
					data-target="#myModalll"><span
						class="glyphicon glyphicon-user"></span> My Page</a></li>
				<li><a href="/ppp/hotel/hotellogout"><span
