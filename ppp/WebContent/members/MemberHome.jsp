         ...
         <div class="row">
            <div class="col-sm-3 col-md-6 col-lg-3 btnimg">
               <a href="/ppp/hotel/hotelareasearch"><img
                  src="/ppp/images/area.png" width="150px" height="170"><br>지역별 호텔보기</a>
            </div>
            <div class="col-sm-3 col-md-6 col-lg-3 btnimg">
            ...
            <div class="col-sm-3 col-md-6 col-lg-3 btnimg"> 
               <a href="/ppp/hotel/hotelreviewsearch"><img
                  src="/ppp/images/review.png" width=" 150px" height="170"><br>리뷰순 호텔보기</a>
            </div>
         </div>
         <br>
         <div class="container">
            <button type="button" class="btn btn-info" data-toggle="collapse"
               data-target="#demo">이용방법</button>
