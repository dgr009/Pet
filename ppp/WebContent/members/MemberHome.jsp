...
<%@ include file="header/BigHeader.jsp" %>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-3 col-md-6 col-lg-3 btnimg" 
					...
					<a href="#"><img src="https://s-media-cache-ak0.pinimg.com/originals/03/1f/86/031f86ad9fb180893a2d899aeaceb44e.jpg" width="150px" height="170"><br>지역별 호텔보기</a>
				</div>
				<div class="col-sm-3 col-md-6 col-lg-3 btnimg"  
					style="background-color: white;"> 
					<a href="#"><img src="http://cfile24.uf.tistory.com/image/2419AD4652FC36A7345270" width="150px" height="170"><br>평점순 호텔보기</a>
				</div>
				<div class="col-sm-3 col-md-6 col-lg-3 btnimg" 
					style="background-color: white;"> 
					<a href="#"><img src="http://cfile6.uf.tistory.com/image/1418904C5053417C19157A" width="150px" height="170"><br>리뷰순 호텔보기</a> 
				</div>
			</div>
			<div class="row">
				<div class="col-sm-9 col-md-12 col-lg-8"
					style="background-color: white;">
					<h5>이용방법</h5>
					<h6>아픈동물은 죄송하지만 이용하실수 없습니다<br>최근한달내에 수술한친구들은 이용하실수 없습니다</h6>
				</div>
			</div>
		</div>
	</div>
	<div id="section42" class="container">
		<h2>동물병원</h2>
		<div class="containe">     //난 취하지않아 캬 캬 캬 
			<h2>동물병원 보기</h2>
			<p>동물병원을 전체, 지역별, 평점순으로 찾아볼수 있습니다</p>
			<div class="row">
				<div class="col-sm-3 col-md-6 col-lg-4"
					style="background-color: white;">
						<img src="http://cfile6.uf.tistory.com/image/1418904C5053417C19157A" width="113.5px"><br>
					<a href="#" class="btn btn-info" role="button">전체 병원보기</a>
				</div>
				<div class="col-sm-3 col-md-6 col-lg-4"
					style="background-color: white;">
					<img src="https://s-media-cache-ak0.pinimg.com/originals/03/1f/86/031f86ad9fb180893a2d899aeaceb44e.jpg" width="113.5px"><br>
					<a href="#" class="btn btn-info" role="button">지역별 병원보기</a>
				</div>
				<div class="col-sm-3 col-md-6 col-lg-4"
					style="background-color: white;">
							<img src="http://cfile24.uf.tistory.com/image/2419AD4652FC36A7345270" width="180.5px"><br>
					<a href="#" class="btn btn-info" role="button">평점순 병원보기</a>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-9 col-md-12 col-lg-8"
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-3 col-md-6 col-lg-4" 
					style="background-color: white;">
					<img src="http://cfile6.uf.tistory.com/image/1418904C5053417C19157A" width="113.5px"><br>
					<a href="#" class="btn btn-info" role="button">전체 애견샵보기</a>
				</div>
				<div class="col-sm-3 col-md-6 col-lg-4"
					style="background-color: white;">
					<img src="https://s-media-cache-ak0.pinimg.com/originals/03/1f/86/031f86ad9fb180893a2d899aeaceb44e.jpg" width="113.5px"><br>
					<a href="#" class="btn btn-info" role="button">지역별 애견샵보기</a>
				</div>
				<div class="col-sm-3 col-md-6 col-lg-4"
					style="background-color: white;">
					<img src="http://cfile24.uf.tistory.com/image/2419AD4652FC36A7345270" width="180.5px"><br>
					<a href="#" class="btn btn-info" role="button">평점순 애견샵보기</a>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-9 col-md-12 col-lg-8"
